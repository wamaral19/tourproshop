...
export const metadata: Metadata = {
  ...
  description:
    "Licensed merchandise extends sponsor reach far beyond tournament broadcasts — turning fans into year-round, walking impressions for your brand.",
      ...
      <section className="border-b border-line bg-brand-cream">
        <div className="mx-auto max-w-[1400px] px-4 pb-10 pt-12 md:px-8 md:pb-14 md:pt-16">
          <div className="grid gap-10 md:grid-cols-[minmax(0,1.15fr)_minmax(0,1fr)] md:items-center md:gap-14">
            <div>
              <p className="eyebrow text-brand-deep text-xl md:text-3xl">For sponsors</p>
              <h1 className="mt-4 font-sans text-4xl font-semibold leading-[1.05] tracking-tight text-brand-ink md:text-6xl lg:text-7xl">
                Get more out of your sponsorships.
              </h1>
              <p className="mt-6 font-sans text-lg leading-relaxed text-brand-ink/70 md:text-xl">
                Tour Pro Shop unlocks value from your player sponsorships by
                selling player-specific merchandise with your corporate logo.
              </p>
            </div>
          ...
          <div className="mt-8 border-t border-line pt-8 md:mt-12 md:pt-10">
            ...
            <p className="mt-4 max-w-2xl font-sans text-base leading-relaxed text-brand-ink/65 md:text-lg">
              Earned media is king today - we're not changing that. We&apos;re here to fill the gaps,
              making your sponsorships drive value even when a player isn&apos;t getting airtime. The reliance on earned
              media creates massive variance in brand presence. Spikes will always exist, but variance will go down as sponsor patch presence goes up.
            </p>
