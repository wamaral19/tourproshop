...
export const products: Product[] = [
    ...
    images: [
      {
        ...
        bgColor: "#dad9dd",
        hotspots: [
          { x: 50, y: 19, sponsorName: "Municipal" },
          { x: 37, y: 41, sponsorName: "Power Design" },
          { x: 63, y: 41, sponsorName: "SoFi" },
        ],
      },
      {
  ...
  createProduct({
    ...
    price: 138,
    description:
      "Sam Burns's Sunday look — Peter Millar's Albatross piqué polo in white, with his full sponsor lineup intact, from Mastercard and Raising Cane's to the newly added iCapital at the right chest. The perfect blend of traditional and technical: a pima cotton base brings softness and classic texture, while blended performance yarns add four-way stretch. Designed in an Oxford piqué knit and detailed with mother-of-pearl buttons.",
    details: [
      ...
      "Tailored fit",
      "Tour sponsor placements: Mastercard, ADP, iCapital, Topgolf, RBC, Raising Cane's",
    ...
    images: [
      {
        ...
        bgColor: "#f4f3f1",
        hotspots: [
          { x: 50, y: 10, sponsorName: "Peter Millar" },
          { x: 36, y: 20, sponsorName: "Raising Cane's" },
          { x: 62, y: 21, sponsorName: "Mastercard" },
          { x: 37, y: 33, sponsorName: "ADP" },
          { x: 62, y: 34, sponsorName: "iCapital" },
          { x: 16, y: 37, sponsorName: "Topgolf" },
          { x: 84, y: 36, sponsorName: "RBC" },
        ],
      },
      {
    ...
    images: [
      {
        ...
        colorway: "Blue",
        hotspots: [
          { x: 39, y: 34, sponsorName: "NICE" },
          { x: 61, y: 34, sponsorName: "PUMA" },
          { x: 23, y: 40, sponsorName: "Tradeweb" },
          { x: 76, y: 38, sponsorName: "Amerisure" },
        ],
      },
      {
